...
- 구성 (반드시 이 3단 구조를 지킬 것):
  ...
  3) CTA 1줄: 마지막 줄은 반드시 팔로우/저장/댓글/DM 중 하나를 유도하는 짧고 명확한 행동 유도 문구로 마무리할 것
- 금지 사항: 절대로 AI 냄새가 나거나, 뻔한 광고체, 상투적인 어조를 쓰지 말 것. (특히 '오늘은~알아보겠습니다', '결론부터', '첫째둘째셋째', '따라서', '즉' 같은 단어는 사용 절대 금지. 존댓말 어미도 금지)
- 가독성: 3~4줄 각각을 짧게 끊어 이모지와 함께 줄바꿈(개행)할 것. 긴 문장/설명조 문장 금지.
...
- 절대로 설명이나 마크다운 백틱 코드블록(\`\`\`json 등)을 두르지 말고 오로지 파싱 가능한 순수 JSON 텍스트 하나만 리턴해줘. JSON 규격:
{
  ...
  "selected_topic": "[선정된 주제 1개]",
  "title": "[스레드 메인 주제 키워드]",
  "body": "[3~4줄, 총 40~60자 내외의 초단문 반말체 스레드 본문 (1줄 훅 -> 1~2줄 핵심 메시지 -> 1줄 CTA, 이모지와 줄바꿈 적용)]",
  "hashtags": "[해시태그 10개]"
}`;
}
